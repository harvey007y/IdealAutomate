...
namespace WrapSQLInQuotesForCS {
    ...
    public partial class MainWindow : Window {
            ...
            var window = new Window() //make sure the window is invisible
      {
            ...
            string settingsDirectory = myActions.GetAppDirectoryForScript(strScriptName);
            ...
            string strContent = settingsDirectory + @"\SQL_In.txt";
            ...
            string strInFile = settingsDirectory + @"\SQL_In.txt";
            // private string strInFile = @"C:\Data\LanguageXMLInput3.txt";
            string strOutFile = settingsDirectory + @"\SQL_Out_Wrapped.txt";
