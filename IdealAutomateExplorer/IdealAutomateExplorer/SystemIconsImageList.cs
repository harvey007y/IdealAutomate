...
namespace System.Windows.Forms.Samples {
	public class SystemIconsImageList : IDisposable
	{
        ...
        #region Fields
        private Dictionary<string, Icon> _dictionary = new Dictionary<string, Icon>();
		...
		public Icon GetIcon(string FileName)
		{
			...
			if (_dictionary.ContainsKey(ext))
			{
				return (Icon)(_dictionary[ext]).Clone(); 
			}
			else
			{
