...
class DataGridViewColumnSelector
    {
        ...
        private DataGridViewExt mDataGridView = null;
        ...
        /// </summary>
        public DataGridViewExt DataGridView
        {
        ...
        public void ShowHideColumns() {
            ...
            mCheckedListBox.Height = (PreferredHeight < MaxHeight) ? PreferredHeight : MaxHeight;
            mCheckedListBox.Width = this.Width;
            mPopup.Show(mDataGridView.PointToScreen(new System.Drawing.Point(100, 200)));
        }
        ...
        public DataGridViewColumnSelector(DataGridViewExt dgv) : this() {
