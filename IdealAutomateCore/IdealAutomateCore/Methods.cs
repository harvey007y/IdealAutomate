            ...
            try
            {
                ...
                try
                {
                    ...
                    if (Clipboard.GetData(DataFormats.Text) == null)
                    {
                        ...
                        {
                            Console.WriteLine("Clipboard returned null max times - setting entity to nothing");
                            Logging.WriteLogSimple("Clipboard returned null max times - setting entity to nothing");
                            myEntity = "";
                            return myEntity;
                        }
                    }
