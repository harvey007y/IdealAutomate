      ...
      var window = new Window() //make sure the window is invisible
{
      ...
      if (strWindowTitle.StartsWith("MessageBoxShow")) {
      ...
      myActions.Sleep(1000);
        ...
        DisplayMessageBoxShow:
            ...
            if (strButtonPressed == "btnOkay") { 
                ...
                WriteCodeBodyToExternalFile(strAppendCodeToExistingFile, strOutCodeBodyFile, strMessageToUse);
      ...
      Application.Current.Shutdown();
        ...
        private void WriteCodeBodyToExternalFile(string strAppendCodeToExistingFile, string strOutCodeBodyFile, string strMessageToUse)
        {
            ...
            if (strAppendCodeToExistingFile.ToLower() == "true")
            {
                ...
                {
                    file.WriteLine("myActions.MessageBoxShow(" + strMessageToUse + ");");
