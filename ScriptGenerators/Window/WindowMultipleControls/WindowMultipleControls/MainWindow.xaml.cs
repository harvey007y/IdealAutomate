...
namespace MultipleWindowControls
{
    /// <summary>
    ...
    "      }     \r\n";
                ...
                if (_PositionType == "Relative")
                {
                    ...
                    " myControlEntity" + strSuffix + " = new ControlEntity();" +
                                  relativeCodeSnippet + " strButtonPressed = myActions.WindowMultipleControls" + strMinimized + "(ref myListControlEntity" + strSuffix + " , " + intWindowHeight + ", " + windowWidthTemp + ", newTop,  newLeft);" + sb2.ToString() +
...
";
                ...
                else
                {
                    code = sbCode.ToString() +
 sb.ToString() +
              " strButtonPressed = myActions.WindowMultipleControls" + strMinimized + "(ref myListControlEntity" + strSuffix + " , " + intWindowHeight + ", " + windowWidthTemp + "," + startPointYTemp + ", " + startPointXTemp + ");" + sb2.ToString() +
 "Console.WriteLine(\"Hello, world!\");"
                   + @"
            }"
                    + sbFunctions.ToString() + @"
...
";
                ...
                if (_PositionType == "Relative")
                {
                    myActions.MessageBoxShow(sb.ToString() + relativeCodeSnippet + " strButtonPressed = myActions.WindowMultipleControls" + strMinimized + "(ref myListControlEntity" + strSuffix + " , " + intWindowHeight + ", " + windowWidthTemp + ", newTop, newLeft);" + sb2.ToString());
                }
                else
                {
                    myActions.MessageBoxShow(sb.ToString() + " strButtonPressed = myActions.WindowMultipleControls" + strMinimized + "(ref myListControlEntity" + strSuffix + " , " + intWindowHeight + ", " + windowWidthTemp + "," + startPoint.Y + ", " + startPoint.X + "); " + sb2.ToString());
                }
                goto AddControl;
            }
        ...
        private void WriteCodeBodyToExternalFile(string strMinimized, string _PositionType, string relativeCodeSnippet, string strSuffix, StringBuilder sb, StringBuilder sb2, string strAppendCodeToExistingFile, string strOutCodeBodyFile)
        {
            ...
            if (strAppendCodeToExistingFile.ToLower() == "true")
            {
                using (System.IO.StreamWriter file = System.IO.File.AppendText(strOutCodeBodyFile))
                {
                    ...
                    if (_PositionType == "Relative")
                    {
                        file.WriteLine("strButtonPressed = myActions.WindowMultipleControls" + strMinimized + "(ref myListControlEntity" + strSuffix + ", " + intWindowHeight + ", " + windowWidthTemp + ", newTop, newLeft);");
                    }
                    else
                    {
                        file.WriteLine("strButtonPressed = myActions.WindowMultipleControls" + strMinimized + "(ref myListControlEntity" + strSuffix + ", " + intWindowHeight + ", " + windowWidthTemp + "," + startPoint.Y + ", " + startPoint.X + "); ");
                    }
