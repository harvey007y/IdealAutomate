...
namespace PutCursorPosition
{
    ...
    public partial class MainWindow : Window
    {
        public MainWindow()
        {
            ...
            if (strWindowTitle.StartsWith("PutCursorPosition"))
            {
        ...
        DisplayPutCursorPosition:
            ...
            if (strButtonPressed == "btnOkay")
            {
                ...
                strGeneratedLinex = "int[,] " + strResultValueToUse + " = myActions.PutCursorPosition();";
        ...
        private void WriteCodeBodyToExternalFile(string strAppendCodeToExistingFile, string strOutCodeBodyFile, string strResultValueToUse)
        {
            ...
            if (strAppendCodeToExistingFile.ToLower() == "true")
            {
                ...
                {
                    file.WriteLine(strResultValueToUse + " = myActions.PutCursorPosition();");
